        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            <div class="bg-gradient-to-r from-green-600 to-green-800 rounded-2xl shadow-xl overflow-hidden">
                <div class="p-8 sm:p-10 flex flex-col sm:flex-row items-center justify-between">
                    ...
                    <a href="{{ route('admin.sales.index') }}" class="bg-white text-green-700 hover:bg-green-50 font-bold py-3 px-6 rounded-full shadow-lg transition-transform transform hover:scale-105 flex items-center gap-2">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
                    ...
                    <div class="mt-8">
                        <a href="{{ route('admin.sales.index') }}" class="w-full block text-center text-sm text-green-600 hover:text-green-800 font-bold border border-green-200 rounded-lg py-2 transition-colors">
