            ...
            <div class="row align-items-center">
               ...
               <div class="col-lg-6 mb-30">
                  <div class="ca-btn-cta-3 text-end">
                     <a href="{{ route('second', ['pages', 'contact']) }}" class="ca-btn-primary-3 w-bg">Get Started <span><i class="fa-solid fa-angle-right"></i></span></a>
                  </div>
               </div>
            </div>
                  ...
                  <div class="col-xl-4 col-md-6 mb-30">
                     <div class="ca-footer widget-1">
                        <div class="ca-ft-logo">
                           <a href="{{ route('second', ['demo', 'index-03']) }}"><img src="/img/logo/ca-logo3.1.png" alt=""></a>
                        </div>
