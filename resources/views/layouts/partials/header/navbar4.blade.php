    ...
    <div class="container header-4">
        <div class="row align-items-center">
            <div class="col-xl-3 col-lg col-md-6 col-6">
                <!-- ca-logo -->
                <div class="ca-logo">
                    <a href="{{ route('second', ['demo', 'index-04']) }}"><img src="/img/logo/ca-logo4.1.png" alt=""></a>
                </div>
            </div>
            ...
            <div class="col-xl-3 col-lg col-md-6 col-6">
                ...
                <div class="ca-btn-header d-none d-lg-block text-end">
                    <a href="{{ route('second', ['pages', 'contact']) }}" class="ca-btn-primary ca-btn-primary-4 theme-bg-4 text-white br-50">Track Shipment <span><i class="fa-solid fa-arrow-right"></i></span></a>
                </div>
