...
<head>
    <meta charset="UTF-8">
    <title>Hasil Kalkulasi TCO - <?php echo e($nama); ?></title>
    <style>
...
<body>
        ...
        <table class="header-table">
            <tr>
                <td style="width: 25%; text-align: left; vertical-align: middle;">
                    ...
                    ?>
                    <?php if(!empty($logo_ap_base64)): ?>
                        <img src="<?php echo e($logo_ap_base64); ?>" class="header-logo" alt="Logo AP">
                    <?php else: ?>
                ...
                <td style="width: 25%; text-align: right; vertical-align: middle;">
                    <?php if(!empty($logo_base64)): ?>
                        <img src="<?php echo e($logo_base64); ?>" class="header-logo" alt="Logo Hino">
                    <?php else: ?>
    ...
    <div class="tco-wrapper">
        <table class="report-table">
            <tbody>
                <tr>
                    <th colspan="3" class="main-title-cell">HASIL KALKULASI TCO (Periode <?php echo e($val_periode); ?> Tahun)</th>
                </tr>
                <tr>
                    <td colspan="3" class="nama-pelanggan-cell">Pelanggan: <?php echo e($nama); ?> | Unit: <?php echo e($kategori_model); ?></td>
                </tr>
            </tbody>
            <tbody>
                <tr class="section-header"><td colspan="3">Kalkulasi Total KM (Penggerak Biaya Solar & Ban)</td></tr>
                <tr><td class="item-detail">KM per Tahun</td><td class="item-rumus"><?php echo e($val_km_per_tahun_rumus); ?></td><td class="item-hasil"><?php echo e($val_km_per_tahun_hasil); ?></td></tr>
                <tr><td class="item-detail">Total KM TCO (<?php echo e($val_periode); ?> Tahun)</td><td class="item-rumus"></td><td class="item-hasil"><?php echo e($val_total_km_text); ?></td></tr>
            </tbody>
            <tbody>
                <tr class="section-header"><td colspan="3">Kalkulasi Biaya Akuisisi (Biaya Awal)</td></tr>
                <tr><td class="item-detail">Harga Awal (Pokok)</td><td class="item-rumus"><?php echo e($val_akuisisi_pokok_rumus); ?></td><td class="item-hasil"><?php echo e($val_akuisisi_pokok_hasil); ?></td></tr>
                <tr><td class="item-detail">Total Biaya Bunga</td><td class="item-rumus"><?php echo e($val_bunga_rumus); ?></td><td class="item-hasil"><?php echo e($val_bunga_hasil); ?></td></tr>
                <tr class="total-row"><td class="total-label">Total Akuisisi</td><td class="item-rumus"><?php echo e($val_akuisisi_total_rumus); ?></td><td class="item-hasil total-value"><?php echo e($val_akuisisi_total_hasil); ?></td></tr>
            </tbody>
            <tbody>
                ...
                <tr><td class="item-detail-nested">Total Liter</td><td class="item-rumus"><?php echo e($val_solar_liter_rumus); ?></td><td class="item-hasil"><?php echo e($val_solar_liter_hasil); ?></td></tr>
                <tr><td class="item-detail-nested">Biaya Solar</td><td class="item-rumus"><?php echo e($val_solar_biaya_rumus); ?></td><td class="item-hasil"><?php echo e($val_solar_biaya_hasil); ?></td></tr>
                
                <tr><td class="item-detail-header" colspan="3">B. Total Biaya Ban (Berbasis KM)</td></tr>
                <tr><td class="item-detail-nested">Jumlah Ganti Ban</td><td class="item-rumus"><?php echo e($val_ban_jumlah_rumus); ?></td><td class="item-hasil"><?php echo e($val_ban_jumlah_hasil); ?></td></tr>
                <tr><td class="item-detail-nested">Biaya Ban</td><td class="item-rumus"><?php echo e($val_ban_biaya_rumus); ?></td><td class="item-hasil"><?php echo e($val_ban_biaya_hasil); ?></td></tr>
                
                <tr><td class="item-detail-header" colspan="3">C. Total Biaya Servis (Berbasis Waktu)</td></tr>
            </tbody>
            
            <tbody>
                <?php $__currentLoopData = $rincian_servis; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $servis): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php if($loop->first): ?>
                        <tr>
                            <td class="item-detail-nested">Biaya Tahun 1</td>
                            <td class="item-rumus"></td>
                            <td class="item-hasil"><?php echo e(formatRupiah($servis['biaya'])); ?></td>
                        </tr>
                    <?php else: ?>
                        <tr>
                            <td class="item-detail-nested">Biaya Tahun <?php echo e($servis['tahun']); ?> (Inflasi 15%)</td>
                            <td class="item-rumus"><?php echo e(formatRupiah($servis['biaya_sebelum'])); ?> * 1.15</td>
                            <td class="item-hasil"><?php echo e(formatRupiah($servis['biaya'])); ?></td>
                        </tr>
                    <?php endif; ?>
            ...
            <tbody>
                <tr class="total-row-nested"><td class="total-label-nested">Total Servis</td><td class="item-rumus"></td><td class="item-hasil total-value"><?php echo e($val_servis_total_hasil); ?></td></tr>
            </tbody>
            <tbody>
                 <tr class="total-row"><td class="total-label">Total Operasional (A + B + C)</td><td class="item-rumus"></td><td class="item-hasil total-value"><?php echo e($val_operasional_total_hasil); ?></td></tr>
            </tbody>
        </table>
        ...
        <table class="report-table">
            <tbody id="section-hjk">
                ...
                <tr><td class="item-detail">Harga Awal</td><td class="item-rumus"></td><td class="item-hasil"><?php echo e($val_hjk_awal_hasil); ?></td></tr>
            </tbody>
            <tbody id="report_hjk_rincian">
                <?php $__currentLoopData = $rincian_depresiasi; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $depr): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        <td class="item-detail-nested">Nilai Akhir Tahun <?php echo e($depr['tahun']); ?> (Turun <?php echo e($depr['rate']); ?>%)</td>
                        <td class="item-rumus"><?php echo e(formatRupiah($depr['nilai_sebelum'])); ?> * <?php echo e((100 - $depr['rate']) / 100); ?></td>
                        <td class="item-hasil"><?php echo e(formatRupiah($depr['nilai_sesudah'])); ?></td>
                    </tr>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </tbody>
            <tbody>
                <tr class="total-row-nested"><td class="total-label-nested">Harga Jual Kembali (Tahun <?php echo e($val_periode); ?>)</td><td class="item-rumus"></td><td class="item-hasil total-value"><?php echo e($val_hjk_final_hasil); ?></td></tr>
            </tbody>
            <tfoot class="final-results">
                <tr class="section-header-final"><td colspan="3" style="border-top: 2px solid #009b44;">Hasil Akhir Simulasi (<?php echo e($val_periode); ?> Tahun)</td></tr>
                <tr><td class="item-detail">Total Biaya Akuisisi</td><td class="item-rumus"></td><td class="item-hasil"><?php echo e($val_final_akuisisi); ?></td></tr>
                <tr><td class="item-detail">Total Biaya Operasional</td><td class="item-rumus"></td><td class="item-hasil"><?php echo e($val_final_operasional); ?></td></tr>
                <tr><td class="item-detail">(-) Harga Jual Kembali</td><td class="item-rumus"></td><td class="item-hasil"><?php echo e($val_final_hjk); ?></td></tr>
                
                <tr class="total-row"><td class="total-label" style="font-size: 1.1em;">TOTAL TCO (Biaya Bersih)</td><td class="item-rumus"></td><td class="item-hasil total-value final-tco"><?php echo e($val_final_tco); ?></td></tr>
                
                <tr class="section-header-final" style="border-top: 4px solid #009b44;"><td colspan="3">Metrik Kunci untuk Pelanggan</td></tr>
                
                <tr class="total-row" style="background-color: #fff;"><td class="total-label" style="padding-top: 15px;">Total TCO</td><td class="item-rumus" style="padding-top: 15px;"></td><td class="item-hasil total-value" style="padding-top: 15px;"><?php echo e($val_metric_tco); ?></td></tr>
                <tr><td colspan="3" class="metric-explanation"><b>Fungsinya: Menunjukkan HASIL AKHIR (Perbandingan Aset).</b><br>Total biaya bersih yang sebenarnya pelanggan keluarkan selama <?php echo e($val_periode); ?> Tahun dan angka final untuk membandingkan HINO dengan pesaing.</td></tr>
                
                <tr class="total-row" style="border-top: 1px dashed #d1d5db !important; background-color: #fff;"><td class="total-label">TCO per Bulan</td><td class="item-rumus"><?php echo e($val_metric_bulan_rumus); ?></td><td class="item-hasil total-value final-metric"><?php echo e($val_metric_bulan_hasil); ?></td></tr>
                ...
                <tr class="total-row" style="border-top: 1px dashed #d1d5db !important; background-color: #fff;"><td class="total-label">TCO per KM</td><td class="item-rumus"><?php echo e($val_metric_km_rumus); ?></td><td class="item-hasil total-value final-metric"><?php echo e($val_metric_km_hasil); ?></td></tr>
                <tr><td colspan="3" class="metric-explanation"><b>Fungsinya: Menunjukkan PROFITABILITAS (Biaya vs Pendapatan).</b><br>Ini adalah biaya produksi per kilometer. Contoh jika ongkos angkut pelanggan <b style="color: #111827;"><?php echo e($val_metric_ongkos_angkut); ?></b>, maka Profit kotor yang dihasilkan adalah <b style="color: #059669;"><?php echo e($val_metric_profit_kotor); ?></b>.</td></tr>
            </tfoot>
        </table>
...
<?php /**PATH C:\xampp\htdocs\LaravelProject\Sales\WebSales\resources\views/pdf/tco-report.blade.php ENDPATH**/ ?>