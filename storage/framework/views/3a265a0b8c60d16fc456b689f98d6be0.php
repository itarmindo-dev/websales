        ...
        <div class="animation-preloader">
            ...
            <div class="spinner-wrapper">
                ...
                <div class="truck-orbit" id="truckOrbit">
                    <img src="<?php echo e(asset('img/icon/truck-16.png')); ?>" alt="Truk Loading">
                </div>

                <div class="logo-hino-container" id="logoContainer">
                    <img src="<?php echo e(asset('img/icon/logohino2.png')); ?>" id="hinoLogo" alt="Logo Hino">
                </div>
            </div>
...
</script><?php /**PATH C:\xampp\htdocs\LaravelProject\Sales\WebSales\resources\views/layouts/partials/loader.blade.php ENDPATH**/ ?>