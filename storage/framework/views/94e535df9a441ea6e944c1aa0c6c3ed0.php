                ...
                <div class="row">
                    ...
                    <div class="col-xl-4 col-md-6 mb-30">
                        <div class="ca-ser-icon-box ca-ser-icon-box-2 fix p-relative cream-bg-3 z-index-1 p-32 br-7">
                            ...
                            <div class="ca-service-content ca-service-content-iner">
                                <h4 class="ca-title fnw-700 pb-16 pt-32"><a href="<?php echo e(route('second', ['services', 'single'])); ?>">Express Delivery Services</a></h4>
                                <p class="pb-24">
                                ...
                                <a href="<?php echo e(route('second', ['services', 'single'])); ?>" class="read-more">Read More <span><i class="fa-solid fa-angle-right"></i></span></a>
                            </div>
                        </div>
                    </div>
                    <!-- single service box -->
                    <div class="col-xl-4 col-md-6 mb-30">
                        <div class="ca-ser-icon-box ca-ser-icon-box-2 fix p-relative cream-bg-3 z-index-1 p-32 br-7">
                            ...
                            <div class="ca-service-content ca-service-content-iner">
                                <h4 class="ca-title fnw-700 pb-16 pt-32"><a href="<?php echo e(route('second', ['services', 'single'])); ?>">Supply Chain Management</a></h4>
                                <p class="pb-24">
                    ...
                    <div class="col-xl-4 col-md-6 mb-30">
                        <div class="ca-ser-icon-box ca-ser-icon-box-2 fix p-relative cream-bg-3 z-index-1 p-32 br-7">
                            ...
                            <div class="ca-service-content ca-service-content-iner">
                                <h4 class="ca-title fnw-700 pb-16 pt-32"><a href="<?php echo e(route('second', ['services', 'single'])); ?>">Project Cargo Handling</a></h4>
                                <p class="pb-24">
                    ...
                    <div class="col-xl-4 col-md-6 mb-30">
                        <div class="ca-ser-icon-box ca-ser-icon-box-2 fix p-relative cream-bg-3 z-index-1 p-32 br-7">
                            ...
                            <div class="ca-service-content ca-service-content-iner">
                                <h4 class="ca-title fnw-700 pb-16 pt-32"><a href="<?php echo e(route('second', ['services', 'single'])); ?>">Warehousing Solutions</a></h4>
                                <p class="pb-24">
                    ...
                    <div class="col-xl-4 col-md-6 mb-30">
                        <div class="ca-ser-icon-box ca-ser-icon-box-2 fix p-relative cream-bg-3 z-index-1 p-32 br-7">
                            ...
                            <div class="ca-service-content ca-service-content-iner">
                                <h4 class="ca-title fnw-700 pb-16 pt-32"><a href="<?php echo e(route('second', ['services', 'single'])); ?>">International Shipping</a></h4>
                    ...
                    <div class="col-xl-4 col-md-6 mb-30">
                        <div class="ca-ser-icon-box ca-ser-icon-box-2 fix p-relative cream-bg-3 z-index-1 p-32 br-7">
                            ...
                            <div class="ca-service-content ca-service-content-iner">
                                <h4 class="ca-title fnw-700 pb-16 pt-32"><a href="<?php echo e(route('second', ['services', 'single'])); ?>">Cold Chain Logistics</a></h4>
                                <p class="pb-24">
                    ...
                    <div class="col-xl-4 col-md-6 mb-30">
                        <div class="ca-ser-icon-box ca-ser-icon-box-2 fix p-relative cream-bg-3 z-index-1 p-32 br-7">
                            ...
                            <div class="ca-service-content ca-service-content-iner">
                                <h4 class="ca-title fnw-700 pb-16 pt-32"><a href="<?php echo e(route('second', ['services', 'single'])); ?>">Inventory Management</a></h4>
                                <p class="pb-24">
                    ...
                    <div class="col-xl-4 col-md-6 mb-30">
                        <div class="ca-ser-icon-box ca-ser-icon-box-2 fix p-relative cream-bg-3 z-index-1 p-32 br-7">
                            ...
                            <div class="ca-service-content ca-service-content-iner">
                                <h4 class="ca-title fnw-700 pb-16 pt-32"><a href="<?php echo e(route('second', ['services', 'single'])); ?>">Domestic Transport</a></h4>
                                <p class="pb-24">
...
<?php echo $__env->make('layouts.base', ['title' => 'Service'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\LaravelProject\Sales\WebSales\resources\views/services/service.blade.php ENDPATH**/ ?>