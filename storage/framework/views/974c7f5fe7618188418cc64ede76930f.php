    ...
    <div class="container ca-header-bg-2">
        <div class="row align-items-center">
            <div class="col-lg-3 col-md-6 col-6">
                <!-- ca-logo -->
                <div class="ca-logo">
                    <a href="<?php echo e(route('second', ['demo', 'index-02'])); ?>"><img src="/img/logo/ca-logo2.1.png" alt=""></a>
                </div>
            </div>
            ...
            <div class="col-lg-3 col-md-6 col-6">
                ...
                <div class="ca-btn-header text-end d-none d-lg-block">
                    <a href="<?php echo e(route('second', ['pages', 'contact'])); ?>" class="ca-btn-primary-22">Get A Free Quote <span><i class="fa-solid fa-arrow-right"></i></span></a>
                </div>
...
<!-- offcanvas end -->
<?php /**PATH C:\xampp\htdocs\LaravelProject\Sales\WebSales\resources\views/layouts/partials/header/navbar2.blade.php ENDPATH**/ ?>