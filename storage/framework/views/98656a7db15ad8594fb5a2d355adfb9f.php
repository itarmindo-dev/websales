    ...
    <div class="ca-offcanvas-wrapper">
        <div class="ca-offcanvas-header d-flex justify-content-between align-items-center mb-40">
            <div class="ca-offcanvas-logo">
                <a href="#"> <img src="<?php echo e(asset('img/logo/logohinopth.png')); ?>" alt="Logo Mitra" style="height: 60px; width: auto; object-fit: contain;"></a>
            </div>
...
<!-- offcanvas end -->
<?php /**PATH C:\xampp\htdocs\LaravelProject\Sales\WebSales\resources\views/layouts/partials/header/mobile-nav.blade.php ENDPATH**/ ?>