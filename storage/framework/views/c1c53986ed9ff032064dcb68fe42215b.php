<footer class="theme-bg-3 pt-30 p-relative z-index-1">
      <div class="ca-ft-shape p-absolute ft-shape-2"><img src="/img/shape/ca-footer-shape3.1.png" alt=""></div>
            ...
            <div class="row align-items-center">
               <div class="col-lg-6 mb-30">
                  <div class="ca-cta-content">
                     <h2 class="ca-section-title cta-title-1 text-white fnw-700">Join Us Today And let Us Help You To Grow Your Business.</h2>
                  </div>
               </div>
               <div class="col-lg-6 mb-30">
                  <div class="ca-btn-cta-3 text-end">
                     <a href="<?php echo e(route('second', ['pages', 'contact'])); ?>" class="ca-btn-primary-3 w-bg">Get Started <span><i class="fa-solid fa-angle-right"></i></span></a>
                  </div>
               </div>
            </div>
                  ...
                  <div class="col-xl-4 col-md-6 mb-30">
                     <div class="ca-footer widget-1">
                        <div class="ca-ft-logo">
                           <a href="<?php echo e(route('second', ['demo', 'index-03'])); ?>"><img src="/img/logo/ca-logo3.1.png" alt=""></a>
                        </div>
                  ...
                  <div class="col-xl col-md-6 mb-30">
                     <div class="ca-footer widget-2">
                        ...
                        <div class="ca-footer-menu ca-footer-menu-3">
                           <ul>
                              <li><a href="<?php echo e(route('any', 'index')); ?>">Home</a></li>
                              ...
                              <li><a href="<?php echo e(route('second', ['blogs', 'blog'])); ?>">Latest News</a></li>
   ...
   <!-- footer section end-->
<?php /**PATH C:\xampp\htdocs\LaravelProject\Sales\WebSales\resources\views/layouts/partials/footer.blade.php ENDPATH**/ ?>